...
- `TOKEN_ADDRESS` — `TBD` (`$AWO` SPL mint on Solana).
...
- [x] ~~Lock release-time constants for token launch~~ — done in plugin v0.2.0: `TOKEN_ADDRESS = TBD`, `LAUNCH_DATE = 1776811608`. Submodule pin bumped.
